 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              Vidyaranya Nagar, Tollgate<br>
		              Bangaluru - 560 023, Karnataka<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+918431344952"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+918431344952"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="champgow213@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
       ...
       <button target="_blank" href="mailto:champgow213@gmail.com" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <button target="_blank" href="https://www.instagram.com/" rel="nofollow" class="btn btn-icon-only btn-instagram rounded-circle" data-toggle="tooltip" data-original-title="Follow us">
          ...
          <button target="_blank" href="https://github.com/" rel="nofollow" class="btn btn-icon-only btn-github rounded-circle" data-toggle="tooltip" data-original-title="Star on Github">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p>&copy; Copyright 2026 Crop Census, All Rights Reserved </p>
                </div>
           </div>
        </div>
    </footer>
